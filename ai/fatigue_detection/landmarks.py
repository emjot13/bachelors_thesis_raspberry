...
class Landmarks:
    ...
    def one_eye_aspect_ratio(eye):  # calculates openness of an eye
        ...
        one_eye_ear = (eye_height_line_1 + eye_height_line_2) / (2.0 * eye_width)
        return one_eye_ear
    ...
    def eyes_aspect_ratio(self, gray_image, rect):
        ...
        left_ear =  Landmarks.one_eye_aspect_ratio(left_eye)
        right_ear = Landmarks.one_eye_aspect_ratio(right_eye)
        total_ear = (left_ear + right_ear) / 2.0
        return total_ear
